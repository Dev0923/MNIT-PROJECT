...
import { ArrowLeft, Paperclip, AlertCircle, CheckCircle2, ClipboardList, X } from "lucide-react";
...
export function OtherPermissionsPage() {
  ...
  return (
    <div className="min-h-screen py-10 px-4 md:px-8 relative" style={{ backgroundColor: C.cream }}>
      ...
      <main className="max-w-2xl mx-auto rounded-2xl overflow-hidden shadow-xl bg-white border border-gray-150 mt-12 p-6 md:p-8">
          ...
          {!isSubmitted ? (
            ...
            >
              ...
              <p className="text-xs text-gray-500 mt-2 mb-6 leading-relaxed">
                Your application for other permissions has been logged locally. You can review or apply for other permissions using the buttons below.
              </p>
